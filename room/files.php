  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> E-Arsip <small>Semua File</small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card card-outline card-info">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  <button type="button" class="btn btn-outline-info btn-sm mt-1" id="td_tfile" data-toggle="modal"
                  data-target="#md_tfile" title="Klik untuk tambah file">
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-sm" id="data1">
                    ...
                    <tbody>
                      <?php
                      $no=1;
                      $Pilih="SELECT * FROM file ORDER BY tg_upload ASC";
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <a href="#" id="td_eberkas" href="#" data-toggle="modal" data-target="#md_eberkas" 
                            data-id_br="<?= $data->id_file; ?>"
                            data-fl_br="<?= $data->file; ?>">
                        ...
                        <td>
                          ...
                          <a title="Ubah" class="btn btn-outline-success btn-xs" id="td_efile"
                          href="#" data-toggle="modal" data-target="#md_efile" 
                          data-id="<?= $data->id_file; ?>"
                          data-br="<?= $data->id_brankas; ?>"
                          data-nm="<?= $data->nm_file; ?>"
                          data-tg="<?= $data->tg_upload; ?>"
                          data-vs="<?= $data->visibilitas; ?>"
