...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark"> E-Arsip <small>Brankas</small></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <div class="content">
    <div class="container">
      ...
      <div class="row">
        <?php
        $box = mysqli_query($conn, "SELECT * FROM brankas WHERE bg_brankas = 'Umum'");
      ...
      <!-- bagian keuangan -->
      <h3 class="m-0 text-dark"><small>Bagian Keuangan</small></h3>
      <hr>
      <div class="row">
        <?php
        $box = mysqli_query($conn, "SELECT * FROM brankas WHERE bg_brankas = 'Keuangan'");
        while ($data = mysqli_fetch_object($box)) {
        ?>
          <div class="col-lg-3">
            <div class="card card-primary card-outline">
